...
ALTER COLUMN "responses" SET DEFAULT 0,
ALTER COLUMN "spend" SET DEFAULT 0;

-- AlterTable
ALTER TABLE "Insight" ADD COLUMN     "companyId" TEXT;
...
-- AddForeignKey
ALTER TABLE "Insight" ADD CONSTRAINT "Insight_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "FileUpload" ADD CONSTRAINT "FileUpload_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE SET NULL ON UPDATE CASCADE;
